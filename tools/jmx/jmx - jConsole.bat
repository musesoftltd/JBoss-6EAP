...
"%JAVA_HOME%\bin\jconsole.exe" -J"-Djava.class.path=%CLASSPATH%" -J"-Djavax.net.ssl.trustStore=%trustStorePath%" -J"-Djavax.net.ssl.trustStorePassword=%trustStorePassword%"
:END
goto :EOF
