...
"%JAVA_HOME%\bin\jvisualvm.exe" "-cp:a" "%CLASSPATH%" -J"-Xms64m" -J"-Xmx256m" -J"-Djava.class.path=%CLASSPATH%" -J"-Djavax.net.ssl.trustStore=..\..\keyStore.p12" -J"-Djavax.net.ssl.trustStorePassword=pword"
:END
goto :EOF
